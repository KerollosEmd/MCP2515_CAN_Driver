...
MCP_CANSTAT_untypedef MCP_u8ListenOnlyModeReq(void){
	 MCP_CANSTAT_untypedef Local_CanStat;
	 MCP_CANCTRL_untypedef Local_CanCtrl;

	 PRIVATE_MCP_voidReadByte(MCP_u8_CANCTRL, &Local_CanCtrl.Byte);

	 Local_CanCtrl.Bits.REQOP=MCP_MODE_LISTENONLY; //request normal mode of operation

	 PRIVATE_MCP_voidWriteByte(MCP_u8_CANCTRL,Local_CanCtrl.Byte);

	 // check mode of operation
	 PRIVATE_MCP_voidReadByte(MCP_u8_CANSTAT, &Local_CanStat.Byte);

	 return Local_CanStat;
 }
 ...
 MCP_CANSTAT_untypedef MCP_u8SleepModeReq(void){
	 ...
	 Local_CanCtrl.Bits.REQOP=MCP_MODE_SLEEP; //request sleep mode of operation
 ...
 MCP_CANSTAT_untypedef MCP_u8ConfigModeReq(void){
	 ...
	 Local_CanCtrl.Bits.REQOP=MCP_MODE_CONFIG; //request Configuration mode of operation
 ...
 MCP_CANSTAT_untypedef MCP_u8LoopbackModeReq(void){
	 ...
	 Local_CanCtrl.Bits.REQOP=MCP_MODE_LOOPBACK; //request Loopback mode of operation
 ...
 MCP_CANSTAT_untypedef MCP_u8NormalModeReq(void){
	 ...
	 Local_CanCtrl.Bits.REQOP=MCP_MODE_NORMAL; //request normal mode of operation
